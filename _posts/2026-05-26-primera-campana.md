---
layout: post
title: "Arranca la primera campaña de muestreo de RECONECTA en las Islas Baleares"
date: 2026-05-26
...
![Sistema de filtración eDNA siendo desplegado desde el Rodman]({{ site.baseurl }}/assets/img/noticias/2026-05-26-pump-inicio.jpeg)  
*El sistema de filtración eDNA durante su despliegue desde cubierta.*

El protocolo de muestreo se desarrolla en cuatro fases a lo largo de la columna de agua: filtrado estático a 40 m de profundidad, seguido de tres tramos de ascenso continuo con filtrado hasta alcanzar los 5 m bajo la superficie. Esto permite capturar el eDNA de las comunidades presentes en distintos estratos verticales, incluida la zona de la termoclina.

![Sistema de filtración eDNA en el agua]({{ site.baseurl }}/assets/img/noticias/2026-05-26-equipo.png)  
*El sistema de filtración eDNA durante su descenso a los 40 m de profundidad.*
...
![Sistema de filtración eDNA a su regreso a bordo]({{ site.baseurl }}/assets/img/noticias/2026-05-26-pump-regreso.jpeg)  
*El sistema de filtración eDNA recuperado tras un muestreo exitoso.*

Los datos obtenidos contribuirán a caracterizar la biodiversidad marina balear y a evaluar la conectividad entre poblaciones en un contexto de cambio global y presiones antrópicas.
